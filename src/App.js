...
import { SearchProvider } from './COMPONENTS/INDEX/SEARCHCOMPONENT/SearchContext';
import SearchBar from './COMPONENTS/INDEX/SEARCHCOMPONENT/SearchBar';
      ...
      <SearchProvider>
        <Router>
          <Routes>
            ...
            <Route path="/content-master" element={<ProtectedRoute><ContentMaster/></ProtectedRoute>} />
          </Routes>
        </Router>
      </SearchProvider>
    </AuthProvider>
